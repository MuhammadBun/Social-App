...
class ListPublicPosts extends StatefulWidget {
  const ListPublicPosts({Key? key}) : super(key: key);

  @override
  State<ListPublicPosts> createState() => _ListPublicPostsState();
}

class _ListPublicPostsState extends State<ListPublicPosts> {
  @override
